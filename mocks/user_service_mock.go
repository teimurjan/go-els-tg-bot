...
func (m *MockUserService) Update(chatID int64, language string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", chatID, language)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockUserServiceMockRecorder) Update(chatID, language interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockUserService)(nil).Update), chatID, language)
}
